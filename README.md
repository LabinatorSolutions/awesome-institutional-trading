...
- **[AlgoStorm Expected Move Levels (EML)](https://www.tradingview.com/u/AlgoStorm/)** — Daily and weekly ±1σ/±2σ bands from an ATM straddle (×0.85), annualized IV (×√(1/252)), or an ADR/AWR fallback; levels lock at the open, no repaint path.
