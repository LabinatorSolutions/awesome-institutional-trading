...
| **Trading Dictionary (Firefox add-on)** | Hover-to-lookup definitions for hundreds of trading terms on any page. Local-only, nothing transmitted. | [→ Open Tool](https://addons.mozilla.org/en-US/firefox/addon/algostorm-trading-dictionary/) |
| **Trading Calculators (Firefox add-on)** | Position sizer, R:R, breakeven win rate, session clock, trade logger with CSV export, in the toolbar. | [→ Open Tool](https://addons.mozilla.org/en-US/firefox/addon/algostorm-trading-calculators/) |
...
- **[AlgoStorm Institutional VWAP Suite (IVS)](https://www.tradingview.com/u/AlgoStorm/)** — Multi-anchor VWAP with volume-weighted population variance bands (σ² = E[x²] − E[x]², not a price standard deviation).
- **[AlgoStorm Institutional Key Levels (IKL)](https://www.tradingview.com/u/AlgoStorm/)** — Prior-day H/L/C, RTH open, opening range, and an array-based value area engine (POC/VAH/VAL) for RTH and Xetra.
- **[AlgoStorm Gamma Exposure Levels (GEX-L)](https://www.tradingview.com/u/AlgoStorm/)** — Plots call walls, put walls and the gamma flip from a 21-value CSV generated by a free SPX GEX dashboard; the script holds no data itself.
- **[AlgoStorm Institutional Session Structure (ISS)](https://www.tradingview.com/u/AlgoStorm/)** — Time-anchored auction skeleton: Asia/London/NY session boxes, Globex overnight range, initial balance with day-type extensions, opening range, overnight inventory read.
- **[AlgoStorm Expected Move Levels (EML)](https://www.tradingview.com/u/AlgoStorm/)** — Daily and weekly ±1/±2 expected-move bands from an ATM straddle, annualized IV or an ADR/AWR fallback, each converted to the same ×0.85 straddle convention; levels lock at the open, no repaint path.
- **[AlgoStorm COT Positioning Index (COT-X)](https://www.tradingview.com/u/AlgoStorm/)** — Williams-style 0–100 stochastic of CFTC net positioning (commercials, large specs, nonreportables) via TradingView's official COT library; Tuesday snapshot, Friday release, swing context only.
...
| **Absorption** | When large passive limit orders absorb aggressive market orders at a level without price moving significantly. Often a precursor to reversal. |
| **Imbalance (Footprint)** | A significant asymmetry between buy and sell volume at a specific price within a candle, indicating directional conviction. |
| **VWAP** | Volume-Weighted Average Price. The key execution benchmark for institutional traders. Used to assess whether a trade was executed above or below average fair value. |
| **Initial Balance (IB)** | The price range established in the first hour of a trading session. Used to classify the day type. |
| **Liquidity Pool** | A concentration of stop orders or limit orders above or below a visible structure level. Institutions often target these areas before reversing. |
| **Wyckoff Accumulation/Distribution** | The staged process by which institutional operators accumulate or distribute large positions without significantly moving price before their intended move. |
| **Market Profile** | A time-price framework developed by J. Peter Steidlmayer that organizes price data into a bell-curve distribution to reveal value areas and market sentiment. |
| **COT Report** | Commitments of Traders. A weekly CFTC report showing the aggregate futures positions of commercials, large speculators, and small speculators. |
| **Gamma Exposure (GEX)** | The aggregate gamma position of options dealers. Indicates whether market makers are likely to buy or sell the underlying asset to hedge their options portfolios as price moves. |
| **0DTE** | Zero-Days-To-Expiration options. Hyper-short-term derivatives that drive massive intraday volume and can induce localized gamma squeezes. |

---

## Community

- **X** — [@algostormlab](https://x.com/algostormlab)
- **TradingView** — [AlgoStorm](https://www.tradingview.com/u/AlgoStorm/)
- **Site** — [algostorm.com](https://algostorm.com/?utm_source=github&utm_medium=readme&utm_campaign=community)
...
Curated with precision by the team at [**AlgoStorm**](https://algostorm.com)
*Institutional Order Flow Trading Education*

- [🌐 Website](https://algostorm.com)
- [🧠 The AlgoStorm Edge](https://algostorm.com/edge/)
- [🛠️ Free Trading Tools](https://algostorm.com/trading-tools/)
